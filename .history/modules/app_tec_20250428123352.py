...
def gerar_documentos_tec():
    ...
    try:
        ...
        try:
            ...
            logger.info(f"numeroSS: {dados.get('numeroSS')}, anoSS: {dados.get('anoSS')}")
...
def init_app_tec(app):
    """
    Função para inicializar funções específicas de relatórios técnicos.
