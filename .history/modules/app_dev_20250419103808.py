...
def gerar_documentos_dev():
    ...
    try:
        ...
        modelos = [
            os.path.join(modelos_path, "ModeloDev - Cronograma e Estória.docx"),
            os.path.join(modelos_path, "ModeloDev - Estrategia de Solucao.docx"),
            os.path.join(modelos_path, "ModeloDev - Relatorio de Acompanhamento.docx")
        ]
