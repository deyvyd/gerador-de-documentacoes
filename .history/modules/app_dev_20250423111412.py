        ...
        for modelo_path in modelos:
            ...
            try:
                ...
                with open(temp_output, 'rb') as doc_file:
                    ...
                    posicao_insercao_inicial = posicao_insercao_final + 2

                    # Processa os requisitos não funcionais
                    processar_requisitos_nao_funcionais(doc, documentacao.requisitos_nao_funcionais, posicao_insercao_inicial)
