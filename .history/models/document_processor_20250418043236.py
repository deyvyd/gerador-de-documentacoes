# modules/document_processor.py - Funções de processamento de documentos
import logging
import os
import re
import tempfile
...
def atualizar_sumario_com_python_docx(caminho_arquivo, titulo_documento=None, titulos=None):
    ...
    # Função auxiliar para criar hyperlinks para marcadores internos
...
# Função que configura o módulo com o aplicativo Flask
def setup_document_processor(app):
    # Não precisa fazer nada aqui por enquanto, pois não estamos registrando rotas
    # Apenas exportando funções para uso em outros módulos
    pass