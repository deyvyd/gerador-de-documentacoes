  ...
  <div class="background-container min-h-screen text-white">
    ...
    <div class="container background-container mx-auto px-4 py-8 mt-8">
      ...
      <div class="main-card background-container p-8 mb-8">
        ...
        <section
          class="info-card mb-8 p-6 border border-blue-300 dark:border-blue-800 rounded-xl shadow-md"
        >
          <!-- Contexto -->
          <div class="mb-8">
        ...
        <section
          class="tabs-card mt-8 p-6 border border-blue-300 dark:border-purple-900 rounded-xl shadow-md"
        >
