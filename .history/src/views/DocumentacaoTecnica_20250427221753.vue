<template>
  <div>
    <toast-notification :toasts="notificationService.toasts"></toast-notification>
    ...
    >
      ...
      <template #actions>
        ...
        <upload-button
          ...
          @json-error="notificationService.show('Erro ao processar o arquivo JSON. Verifique o formato.', 'error')"
          ref="uploadButton"
        />
      </template>
    </app-header>
