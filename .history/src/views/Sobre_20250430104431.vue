        ...
        <div class="space-y-4">
          <div class="bg-blue-800 p-4 rounded-lg mb-4">
            ...
            >
              ...
              <p class="mt-2 border-yellow-100 border-l-4 bg-yellow-900 p-2">
                Observação: O arquivo JSON deve estar no formato correto gerado
                pelo sistema e no tipo correto (Documentação Técnica ou
                Documentação de Desenvolvimento) para que a importação funcione
                corretamente.
              </p>
            </div>
          </div>
