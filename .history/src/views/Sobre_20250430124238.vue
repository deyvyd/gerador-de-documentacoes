        ...
        >
          ...
          <div class="mb-4">
            ...
            <div v-if="tabAtiva === 2" class="campos-container mt-6">
              ...
              <div
                class="mt-3 border-l-4 border-blue-400 dark:border-blue-600 bg-blue-50 dark:bg-blue-900/20 p-3 rounded-r-md"
              >
                <h4
                  class="font-semibold text-base mb-1 flex items-center text-blue-800 dark:text-blue-100"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5 mr-1"
                ...
                <p class="text-blue-800 dark:text-white">
                  Texto da mensagem importante que precisa ser destacada.
                </p>
              </div>
              <div
