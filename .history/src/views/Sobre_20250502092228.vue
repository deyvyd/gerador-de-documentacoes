          ...
          <div class="mb-8">
            ...
            <div class="pl-11">
              <p class="mb-4 text-gray-700 dark:text-gray-300">
                ...
                deste sistema, equipes gastavam horas significativas redigindo
                documentos que muitas vezes tinham padrões inconsistentes devido
                a erros comuns em trabalhos manuais repetitivos.
              </p>
            </div>
          </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                  <div class="flex items-center mb-3">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-8 w-8 mr-3 text-red-600 dark:text-red-400"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
