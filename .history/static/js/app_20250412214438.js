...
const app = createApp({
  ...
  methods: {
    ...
    destacarBotaoAdicionar() {
      ...
      // Aplica uma animação de pulso com Web Animation API
      adicionarBtn.animate(
        [
          ...
          { transform: "scale(1)", boxShadow: "0 0 0 0 rgba(220, 38, 38, 0)" },
        ],
        {
          duration: 1500,
          iterations: 2,
