      ...
      <div class="form-group">
        ...
        <div class="relative">
          ...
          <div
            ...
            class="suggestions-list bg-option-select text-sm absolute z-10 w-full mt-1 bg-white dark:bg-[#151c25] border border-gray-300 dark:border-gray-600 rounded-md shadow-lg"
          >
            <div
