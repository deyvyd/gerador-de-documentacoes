      ...
      <div class="form-group">
        ...
        <div class="relative">
          ...
          <div
            ...
            class="suggestions-list text-sm absolute z-10 w-full mt-1 bg-white dark:bg-[#151C25] border border-gray-300 dark:border-gray-600 rounded-md shadow-lg"
            :class="isDark ? 'bg-[#151C25] border-gray-600' : 'bg-white border-gray-300'"
          >
            <div
