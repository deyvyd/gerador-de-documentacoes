      ...
      <div class="form-group">
        ...
        <div class="relative">
          ...
          <div
            ...
            class="suggestions-list text-sm absolute z-10 w-full mt-1 bg-blue-900 dark:bg-gray-900 text-white border border-blue-700 dark:border-gray-700 rounded-md shadow-lg"
          >
            <div
              ...
              :class="[
                ...
                highlightedIndex === index ? 'bg-blue-800 dark:bg-gray-800' : 'hover:bg-blue-800 dark:hover:bg-gray-800'
              ]"
            >
              {{ autor.nome }}
            </div>
