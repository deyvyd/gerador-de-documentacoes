...
// Componente InfoButton modificado com posicionamento correto no lado direito
const InfoButton = {
  props: {
    tooltipTitle: {
      type: String,
  ...
  template: `
    <div class="fixed top-16 right-4 p-2 rounded-lg cursor-pointer transition-colors duration-200 border border-gray-300 dark:border-gray-600 z-10" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
      <div class="relative inline-block group">
        ...
        <!-- Tooltip -->
        <div
          class="absolute z-10 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-300 bg-blue-700 dark:bg-blue-700 text-white rounded-lg p-4 w-80 right-0 top-8 shadow-lg"
        >
          <div class="relative">
            <!-- Seta do tooltip -->
            <div
              class="absolute -top-2 right-4 w-4 h-4 bg-blue-700 dark:bg-blue-700 transform rotate-45"
            ></div>
