...
const InfoButton = {
  ...
  template: `
    <div class="info-toggle fixed top-[4.5rem] right-4 p-2 rounded-lg cursor-pointer transition-colors duration-200 border border-gray-300 dark:border-gray-600 z-10">
      <div class="relative inline-block group">
        ...
        <!-- Tooltip -->
        <div
          class="absolute z-10 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-300 bg-blue-700 dark:bg-blue-700 text-white rounded-lg p-4 w-80 right-8 top-0 transform translate-y-0 shadow-lg"
        >
          <div class="relative">
            <!-- Seta do tooltip -->
            <div
